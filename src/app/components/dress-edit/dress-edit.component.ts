...
@Component({
  ...
  templateUrl: './dress-edit.component.html',
  styleUrls: ['./dress-edit.component.scss'],
})
export class DressEditComponent implements OnInit {
  ...
  async getPhoto() {
    this.editMode = this.route.snapshot.url[0].path;
